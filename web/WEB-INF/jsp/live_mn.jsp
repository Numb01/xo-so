            ...
            <div class="Main">
                <div class="Left">                    
                    <div class="Left_BANGKQ_title" id="tructiep">
                        <h1>TRỰC TIẾP KẾT QUẢ XỔ SỐ MIỀN NAM ${sDDMMYYYY}</h1>
                    </div>
                    <div class="TRUCTIEPKQXS_box" id="box_time_xsmb">
                        <span class="do">ĐANG CHỜ KQXS MIỀN NAM LÚC 16H15 - ${sDDMMYYYY}</span>. CÒN:
            ...
            (adsbygoogle = window.adsbygoogle || []).push({});
                    ...
                    <c:if test="${lotterys!=null}">
                        <div class="Left_BANGKQ_title">
                            <h2><a href="/xsmn-xo-so-mien-nam-ngay-${fn:replace(lotterys.openDate, '/', '-')}.html" class="linkngay">KẾT QUẢ XỔ SỐ MIỀN NAM ${lotterys.openDate}</a></h2>
                        </div>
