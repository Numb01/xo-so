        ...
        <center>
            ...
            <div class="Main">
                <div class="KQXSMB_box" id="box_time_xsmb">
                    <h1>
                        TRỰC TIẾP KẾT QUẢ XỔ SỐ MIỀN NAM
                        <span>ngày ${sDDMMYYYY}</span>
                    </h1>
                    <div class="TRUCTIEPKQXS_box">
                        <span class="do">ĐANG CHỜ KQXS MIỀN NAM LÚC 16H15 - ${sDDMMYYYY}</span>
            ...
            (adsbygoogle = window.adsbygoogle || []).push({});
                ...
                <!--                <div style="display: none;text-align: center;" id="tructiepqc">
                                    <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
                                     LVS300x250 
                                    <ins class="adsbygoogle"
                                         style="display:inline-block;width:300px;height:250px"
                ...
                <c:if test="${lotterys!=null}">
                    <div class="Left_BANGKQ_title">
                        <h2 class="h2_bg_1">
                            <a href="/xsmn-xo-so-mien-nam-ngay-${fn:replace(lotterys.openDate, '/', '-')}.html" class="linkngay">KẾT QUẢ XỔ SỐ MIỀN NAM ${lotterys.openDate}</a>
                        </h2>
                    </div>
