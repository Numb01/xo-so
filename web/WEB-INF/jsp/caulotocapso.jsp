                    ...
                    <div class="CAU_bg">
                        ...
                        <div class="CAU_box_form">
                            <form method="post" id="frmCau">
                                ...
                                Cặp số:
                                <input name="capsosoicau" id="capsosoicau" type="text" maxlength="2" size="3" class="boxFrom" onkeypress="return isNumber(event)" value="${capsoInput}"/>
                                Biên ngày cầu chạy:
                                <input name="edate" type="text" value="${edate}" maxlength="6" class="boxLich" id="datepicker" style="cursor: pointer"/>
                                Số ngày cầu chạy:&nbsp; 
                                <input name="cau" type="text" value="${cau}" size="3" maxlength="20" class="boxFrom" id="cau" onpaste="return onPate(event)" onkeypress="return isNumber(event)" onkeyup="changeCau();"/><br />                            
                                Tỉnh:
