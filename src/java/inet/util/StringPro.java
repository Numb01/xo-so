...
public class StringPro {
    ...
    public static String sub2RightString(String special, String first, String second, String third,
            String fourth, String fifth, String sixth, String seventh, String eighth) {
    ...
    public List<String> sub2Right(String special, String first, String second, String third, String fourth, String fifth, String sixth, String seventh, String eighth) {
        List result = new ArrayList();
    ...
    public String concatResult(String special, String first, String second, String third, String fourth, String fifth, String sixth, String seventh, String eighth) {
    ...
    public Lottery replaceResultLottery(Lottery lottery, String loto) {
        ...
        for (StringTokenizer stringTokenizer = new StringTokenizer(l.getSecond(), "-"); stringTokenizer.hasMoreTokens();) {
        ...
        for (StringTokenizer stringTokenizer = new StringTokenizer(l.getThird(), "-"); stringTokenizer.hasMoreTokens();) {
            giai = stringTokenizer.nextToken();
            String giai1 = giai;
        ...
        for (StringTokenizer stringTokenizer = new StringTokenizer(l.getFourth(), "-"); stringTokenizer.hasMoreTokens();) {
            giai = stringTokenizer.nextToken();
            String giai1 = giai;
        ...
        for (StringTokenizer stringTokenizer = new StringTokenizer(l.getFifth(), "-"); stringTokenizer.hasMoreTokens();) {
            giai = stringTokenizer.nextToken();
            String giai1 = giai;
        ...
        for (StringTokenizer stringTokenizer = new StringTokenizer(l.getSixth(), "-"); stringTokenizer.hasMoreTokens();) {
            giai = stringTokenizer.nextToken();
            String giai1 = giai;
        ...
        for (StringTokenizer stringTokenizer = new StringTokenizer(l.getSeventh(), "-"); stringTokenizer.hasMoreTokens();) {
            giai = stringTokenizer.nextToken();
            String giai1 = giai;
    ...
    public LotteryResult replaceLotteryResult(LotteryResult lottery, String loto) {
        LotteryResult l = lottery;
        String stempl = "<span class=\"PTLT_text_Trung\">";
        String etempl = "</span>";
        String templ = stempl + loto + etempl;
        boolean isLoto = false;
    ...
    public Lottery replaceResultLotterySpecial(Lottery lottery, String loto, boolean gandb) {
        Lottery l = lottery;
        String stempl = "<span class=\"PTLT_text_Trung\">";
        String etempl = "</span>";
        String templ = stempl + loto + etempl;
        ...
        String str = subRight(giai, 2);
        if (!gandb) {
            if (str.startsWith(loto) || str.endsWith(loto)) {
                giai = giai.substring(0, giai.length() - 2) + str.replace(loto, templ);
                isLoto = true;
            }
        } else {
            if (str.equals(loto)) {
    ...
    public static String buildKeyWordCacTinh(String code, String link, String region) {
        String result = "";
        if (region.equalsIgnoreCase("MT")) {
            result = code;
            result = result + ",sx" + code.substring(2, code.length());
            result = result + ",xo so " + link.trim();
            result = result + "," + code + " truc tiep";
            result = result + "," + code.trim() + " hom nay";
            result = result + ",ket qua xo so " + link.trim();
            result = result + ",xo so " + link.trim()+" hom nay";
            result = result + ",kq" + code.trim();
        }
        if (region.equalsIgnoreCase("MN")) {
            result = code;
            result = result + ",sx" + code.substring(2, code.length());
            result = result + ",xo so " + link.trim();
            result = result + "," + code + " truc tiep";
    ...
    public static String buildTileCacTinh(String code, String region, String company) {
        String result = "";
        if (region.equalsIgnoreCase("MT")) {
            //result = code.toUpperCase() + " - " + "Ket qua xo so " + company.trim() + " - " + "SX" + code.substring(2, code.length()).toUpperCase() + " trực tiếp nhanh vd";
            result = code.toUpperCase() + " - XO SO " + company.trim().toUpperCase() + " - XS " + company.trim().toUpperCase() + " - Kết quả XS "+company.toLowerCase()+" trực tiếp nhanh vl";
        }
        if (region.equalsIgnoreCase("MN")) {
            result = code.toUpperCase() + " - XO SO " + company.trim().toUpperCase() + " - XS " + company.trim().toUpperCase() + " - Kết quả XS "+company.toLowerCase()+" trực tiếp nhanh vl";
        }
    ...
    public static String buildDescCacTinh(String code, String region, String company) {
        String result = "";
        if (region.equalsIgnoreCase("MT")) {
            result = code.trim().toUpperCase() + " - " + "XO SO " + company.trim() + " - XS " + company.trim().toUpperCase() + " - Xem ngay kết quả xổ số " + company + " được tường thuật trực tiếp tại trường quay nhanh va chính xác nhất ngày hôm nay";
        }
        if (region.equalsIgnoreCase("MN")) {
            result = code.trim().toUpperCase() + " - " + "XO SO " + company.trim() + " - XS " + company.trim().toUpperCase() + " - Xem ngay kết quả xổ số " + company + " được tường thuật trực tiếp tại trường quay nhanh va chính xác nhất ngày hôm nay";
        }
