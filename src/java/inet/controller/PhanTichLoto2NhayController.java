 ...
 * @author hanhlm
 */
public class PhanTichLoto2NhayController extends BaseController {

    private static final String sMaxCau = "30";
    private static final String sLon = "0";
    private static final String sNhay = "2";
    ...
    public PhanTichLoto2NhayController() {
    }
    ...
    protected ModelAndView handleRequestInternal(
        ...
        //the seo
        String title = "Soi cầu kết quả xổ số miền bắc theo nháy chính xác ";
        String des = "Soi cầu 2 nháy - Soi cầu lô tô theo nháy - Soi cầu kết quả xổ số miền Bắc theo nháy nhanh nhất, chính xác nhất.";
        String keyword = "soi cau mb, soi cau mien bac theo nhay, soi cau nhay";
        String strH1 = "Cầu loto 2 nháy";
        ...
        if ("pc".equals(strMobile)) {
            mod.setViewName("/phantichloto2nhay");
        } else {
            mod.setViewName("/mobile/phantichloto2nhay");
        }
        ...
        for (int j = 0; j < listPhanTichLoto.size(); j++) {
            ...
            if (capso.equals(phantichLoto.getCapso())) {
                ...
                for (int l = 0; l < arrLottery.size() - 1; l++) {
                    arrLottery.set(l, sp.replaceResultLottery(arrLottery.get(l), listCapso.get(l + 1)));
                }
