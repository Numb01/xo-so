 ...
 * @author hanhlm
 */
public class PhanTichLotoBTController extends BaseController {

    private static final String sMaxCau = "30";
    private static final String sLon = "1";
    ...
    public PhanTichLotoBTController() {
    }
    ...
    protected ModelAndView handleRequestInternal(
        ...
        //the seo
        String title="Soi Cau Bach Thu Mien Bac - Soi cầu miễn phí Lo to bạch thủ";
        String des="Soi Cau Bach Thu - Soi Cau Bach thu lo - Soi Cau Lo To Bach Thu Truc Tuyen- Đưa ra con số loto bạch thủ miễn phí chính xác và chi tiết cho tất cả các tỉnh thành trong nước.";
        String keyword="cau so db, soi casoi cau bach thu, cau lo bach thu, bach thu lo, soi cau lo to bach thu, soi cau lo bach thu, soi cau mien phi, cau mien phiu db, soi cau mien bac dac biet";
        String strH1="Cầu loto bạch thủ";
        ...
        if("pc".equals(strMobile)){
            mod.setViewName("/phantichlotobt");            
        }else{
            mod.setViewName("/mobile/phantichlotobt");            
        }
