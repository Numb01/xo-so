 ...
 * @author hanhlm
 */
public class PhanTichLotoThuController extends BaseController {
    ...
    public PhanTichLotoThuController() {
    }
    ...
    protected ModelAndView handleRequestInternal(
        ...
        String key = tinh + "_" + week + "_" + cau + "_" + edate.replaceAll("/", "");
        ...
        if (hListPhanTichLoto.containsKey(key)) {
            ...
            listPhanTichLoto = thongKeRequest.parserPhanTichLoToThu(tinh, edate, sLon, sNhay, cau, sMaxCau, week);
        ...
        //the seo
        String title = "Thống kê soi cầu xổ số miền Bắc thứ 2,3,...chủ nhật chính xác";
        String des = "Thống kê phân tích kết quả xổ số miền Bắc theo các thứ, đưa ra dự đoán cặp loto chuẩn xác nhất theo thứ các ngày trong tuần.";
        String keyword = "soi cau mb, soi cau xo so mien bac, soi cau mb thu 2, soi cau mb thu 3, soi cau mb thu 4, soi cau mb thu 5, soi cau mb thu 6, soi cau mb thu 7, soi cau mb chu nhat";
        String strH1 = "Cầu loto theo thứ";
        ...
        if ("pc".equals(strMobile)) {
            mod.setViewName("/phantichlototheothu");
        } else {
            mod.setViewName("/mobile/phantichlototheothu");
        }
