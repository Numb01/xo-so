 ...
 * @author hanhlm
 */
public class PhanTichLotoController extends BaseController {
    ...
    protected ModelAndView handleRequestInternal(
        ...
        //the seo
        String title = "Soi Cau XSMB - Soi cầu xổ số miền bắc siêu chuẩn";
        String des = "Soi Cau XSMB - Soi Cau MB - Soi Cau Mien Bac Mien Phi - Phân tích thống kê chi tiết kết quả xổ số miền bắc để đưa ra cầu đẹp sớm nhất chính xác nhất ngày hôm nay.";
