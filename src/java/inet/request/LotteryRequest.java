...
public class LotteryRequest {
    public List<LotteryCompany> parserLotteryCompany(){
        try{
            Gson gson=new Gson();        
            String string=HttpURLRequest.sendGet("http://api.xoso.wap.vn:8080/getdataxs?CMD=GET_LIST_PROVINCE");
    ...
    public List<LotteryNews> parserLotteryNews(String sid,String start,String end){
        try{
            Gson gson=new Gson();        
    ...
    public LotteryNews parserLotteryNewsDetail(String sid,String nid){
        try{
            Gson gson=new Gson();        
