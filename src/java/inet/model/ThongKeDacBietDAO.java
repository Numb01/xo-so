...
public class ThongKeDacBietDAO {
    ...
    private HashMap<String,List<CapSo>> hMapCapso=new HashMap<String, List<CapSo>>();
    private HashMap<String,String> hMapGanMax = new HashMap<String, String>();
    
    private HashMap<String,List<CapSo>> hMapCapsoChanLe=new HashMap<String, List<CapSo>>();
    private HashMap<String,String> hMapGanMaxChanLe = new HashMap<String, String>();
    
    
    private HashMap<String,List<CapSo>> hMapHangChuc=new HashMap<String, List<CapSo>>();
    private HashMap<String,String> hMapGanMaxHangChuc=new HashMap<String,String>();
    
    private HashMap<String,List<CapSo>> hMapHangDonVi=new HashMap<String, List<CapSo>>();
    private HashMap<String,String> hMapGanMaxHangDonVi=new HashMap<String,String>();
    
    private HashMap<String,List<CapSo>> hMapTong=new HashMap<String, List<CapSo>>();
    private HashMap<String,String> hMapGanMaxTong=new HashMap<String,String>();
    
    private HashMap<String,List<CapSo>> hMapHieu=new HashMap<String, List<CapSo>>();
    private HashMap<String,String> hMapGanMaxHieu=new HashMap<String,String>();
    
    private HashMap<String,List<CapSo>> hMapGiaiSo=new HashMap<String, List<CapSo>>();
    private HashMap<String,String> hMapGanMaxGiaiSo=new HashMap<String,String>();
    
    private HashMap<String,List<CapSo>> hMapCham=new HashMap<String, List<CapSo>>();
    private HashMap<String,String> hMapGanMaxCham=new HashMap<String,String>();
    
    private HashMap<String,List<CapSo>> hMapChiaHetCho3=new HashMap<String, List<CapSo>>();
    private HashMap<String,String> hMapGanMaxChiaHetCho3=new HashMap<String,String>();
    
    private HashMap<String,List<CapSo>> hMapKep=new HashMap<String, List<CapSo>>();
    private HashMap<String,String> hMapGanMaxKep=new HashMap<String,String>();
    ...
    public void thongkeCapso(String code,int numOfWeek){        
        ...
        if(numOfWeek <10){numOfWeek=10;}
        if(numOfWeek>50){numOfWeek=50;}
        ...
        if(hCapso!=null&&!hCapso.isEmpty()){
            ...
            for(Iterator it=cResult.iterator();it.hasNext();){
                ...
                if("".equals(strCapso)){continue;}
                if(danhsachCapso==null){danhsachCapso=new ArrayList<CapSo>();}
                capSo=new CapSo();
                ...
                if(hMapGanMax.containsKey(strCapso)){capSo.setGancucdai(Integer.valueOf(hMapGanMax.get(strCapso)));}
                else{capSo.setGancucdai(capSo.getSongaychuave());}
    ...
    public void thongkeNgayNayThangTruoc(String code,int numOfWeek){        
        ...
        if(numOfWeek <12){numOfWeek=12;}
        if(numOfWeek>48){numOfWeek=48;}
        ...
        for(int i=0;i<=numOfWeek;i++){
            ...
            if(lotteryResult!=null){
                if(listLotteryResult==null){listLotteryResult=new ArrayList<Lottery>();}
    ...
    public void thongkeNgayNayNamTruoc(String code,int numOfWeek){        
        ...
        if(numOfWeek <1){numOfWeek=1;}
        if(numOfWeek>6){numOfWeek=6;}
        Lottery lotteryResult=null;                        
        List<Lottery> listLotteryResult= null;
        Today today=new Today();        
        String ddmmyy="";
    ...
    public void thongkeCapsoChiaHetCho3(String code,int numOfWeek){        
        ...
        if(hCapso!=null&&!hCapso.isEmpty()){
            ...
            for(Iterator it=cResult.iterator();it.hasNext();){
                ...
                capSo.setSongaychuave(timGan(strCapso, danhsachCapsoDacBiet));
                capSo.setSolanxuathien(solanxuathien(strCapso, danhsachCapsoDacBiet));
                if(hMapGanMaxChiaHetCho3.containsKey(strCapso)){capSo.setGancucdai(Integer.valueOf(hMapGanMaxChiaHetCho3.get(strCapso)));}
                else{capSo.setGancucdai(capSo.getSongaychuave());}
                capSo.setDayOfWeek(dayOfWeek);
                if("cn".equalsIgnoreCase(capSo.getDayOfWeek())){capSo.setNumDayOfWeek(8);}
                else{capSo.setNumDayOfWeek(Integer.parseInt(dayOfWeek));}
                capSo.setDdmmyyyy(ngayVeGanNhat);
    ...
    public void thongkeCapsoKep(String code,int numOfWeek){        
        ...
        if(hCapso!=null&&!hCapso.isEmpty()){
            ...
            for(Iterator it=cResult.iterator();it.hasNext();){
                ...
                capSo.setSongaychuave(timGan(strCapso, danhsachCapsoDacBiet));
                capSo.setSolanxuathien(solanxuathien(strCapso, danhsachCapsoDacBiet));
                if(hMapGanMaxKep.containsKey(strCapso)){capSo.setGancucdai(Integer.valueOf(hMapGanMaxKep.get(strCapso)));}
                else{capSo.setGancucdai(capSo.getSongaychuave());}
    ...
    public void thongkeHangChuc(String code,int numOfWeek){        
        ...
        if(hCapso!=null&&!hCapso.isEmpty()){
            ...
            for(Iterator it=cResult.iterator();it.hasNext();){
                ...
                if(hMapGanMaxHangChuc.containsKey(hangchuc)){capSo.setGancucdai(Integer.valueOf(hMapGanMaxHangChuc.get(hangchuc)));}
                else{capSo.setGancucdai(capSo.getSongaychuave());}
                capSo.setDdmmyyyy(ngayVeGanNhat);
                danhsachCapso.add(capSo);
            }
    ...
    public void thongkeHangDonVi(String code,int numOfWeek){        
        ...
        if(hCapso!=null&&!hCapso.isEmpty()){
            ...
            for(Iterator it=cResult.iterator();it.hasNext();){
                ...
                if(hMapGanMaxHangDonVi.containsKey(hangdonvi)){capSo.setGancucdai(Integer.valueOf(hMapGanMaxHangDonVi.get(hangdonvi)));}
                else{capSo.setGancucdai(capSo.getSongaychuave());}
                capSo.setDdmmyyyy(ngayVeGanNhat);
                danhsachCapso.add(capSo);
            }
    ...
    public void thongkeTong(String code,int numOfWeek){        
        ...
        if(hCapso!=null&&!hCapso.isEmpty()){
            ...
            for(Iterator it=cResult.iterator();it.hasNext();){
                ...
                if(hMapGanMaxTong.containsKey(tong)){capSo.setGancucdai(Integer.valueOf(hMapGanMaxTong.get(tong)));}
                else{capSo.setGancucdai(capSo.getSongaychuave());}
                capSo.setDdmmyyyy(ngayVeGanNhat);
                danhsachCapso.add(capSo);
            }
    ...
    public void thongkeHieu(String code,int numOfWeek){        
        ...
        if(hCapso!=null&&!hCapso.isEmpty()){
            ...
            for(Iterator it=cResult.iterator();it.hasNext();){
                ...
                if(hMapGanMaxHieu.containsKey(hieu)){capSo.setGancucdai(Integer.valueOf(hMapGanMaxHieu.get(hieu)));}
                else{capSo.setGancucdai(capSo.getSongaychuave());}
                capSo.setDdmmyyyy(ngayVeGanNhat);
                danhsachCapso.add(capSo);
            }
    ...
    public void thongkeCham(String code,int numOfWeek){        
        ...
        if(hCapso!=null&&!hCapso.isEmpty()){
            ...
            for(Iterator it=cResult.iterator();it.hasNext();){
                ...
                if(hMapGanMaxCham.containsKey(cham)){capSo.setGancucdai(Integer.valueOf(hMapGanMaxCham.get(cham)));}
                else{capSo.setGancucdai(capSo.getSongaychuave());}
                capSo.setDdmmyyyy(ngayVeGanNhat);
                danhsachCapso.add(capSo);
            }
    ...
    public void thongkeChanle(String code,int numOfWeek){
        ...
        if(hCapso!=null&&!hCapso.isEmpty()){
            ...
            for(Iterator it=cResult.iterator();it.hasNext();){
                ...
                if(hangChuc(strCapso).equals(hangDonVi(strCapso))){capSo.setKep("kep");}
                else{capSo.setKep("no");}
                danhsachCapso.add(capSo);
            }
        }
    }
    ...
    public void thongkeTheoCapChanle(String code,int numOfWeek){
        ...
        if(hMapGanMaxChanLe.containsKey("CL")){capSo.setGancucdai(Integer.valueOf(hMapGanMaxChanLe.get("CL")));}
        else{capSo.setGancucdai(capSo.getSongaychuave());}
        danhsachCapso.add(capSo);
        ...
        if(hMapGanMaxChanLe.containsKey("CC")){capSo.setGancucdai(Integer.valueOf(hMapGanMaxChanLe.get("CC")));}
        else{capSo.setGancucdai(capSo.getSongaychuave());}
        danhsachCapso.add(capSo);
        ...
        if(hMapGanMaxChanLe.containsKey("LC")){capSo.setGancucdai(Integer.valueOf(hMapGanMaxChanLe.get("LC")));}
        else{capSo.setGancucdai(capSo.getSongaychuave());}
        danhsachCapso.add(capSo);
        ...
        if(hMapGanMaxChanLe.containsKey("LL")){capSo.setGancucdai(Integer.valueOf(hMapGanMaxChanLe.get("LL")));}
        else{capSo.setGancucdai(capSo.getSongaychuave());}
        danhsachCapso.add(capSo);
    }
    ...
    public void thongkeGiaiSo(String code,int numOfWeek){
        ...
        if(hMapGanMaxGiaiSo.containsKey("00-24")){capSo.setGancucdai(Integer.valueOf(hMapGanMaxGiaiSo.get("00-24")));}
        else{capSo.setGancucdai(capSo.getSongaychuave());}
        capSo.setDdmmyyyy(ngayVeGanNhat);
        ...
        if(hMapGanMaxGiaiSo.containsKey("25-49")){capSo.setGancucdai(Integer.valueOf(hMapGanMaxGiaiSo.get("25-49")));}
        else{capSo.setGancucdai(capSo.getSongaychuave());}
        capSo.setDdmmyyyy(ngayVeGanNhat);
        capSo.setSpecial(special);
        danhsachCapso.add(capSo);
        ...
        if(hMapGanMaxGiaiSo.containsKey("50-74")){capSo.setGancucdai(Integer.valueOf(hMapGanMaxGiaiSo.get("50-74")));}
        else{capSo.setGancucdai(capSo.getSongaychuave());}
        capSo.setDdmmyyyy(ngayVeGanNhat);
        capSo.setSpecial(special);
        danhsachCapso.add(capSo);
        ...
        if(hMapGanMaxGiaiSo.containsKey("75-99")){capSo.setGancucdai(Integer.valueOf(hMapGanMaxGiaiSo.get("75-99")));}
        else{capSo.setGancucdai(capSo.getSongaychuave());}
        capSo.setDdmmyyyy(ngayVeGanNhat);
        capSo.setSpecial(special);
        danhsachCapso.add(capSo);
    ...
    private List<CapSo> timCapsoDacBiet(List<Lottery> list){
        ...
        for(int i=0;i<list.size();i++){
            if(listCapso==null){listCapso=new ArrayList<CapSo>();}
    ...
    private String chanle(String capso){
        ...
        String result="";
        if(Integer.parseInt(hangchuc)%2==0){result="C";}
        else{result="L";}
        
        if(Integer.parseInt(hangdonvi)%2==0){result=result+"C";}
    ...
    private String tongCapSo(String capso,boolean bot10){
        ...
        if(bot10){if(result>=10){result=result-10;}}        
    ...
    private String kep(String capso){
        String hangchuc=hangChuc(capso);
        String hangdonvi=hangDonVi(capso);
        if(hangchuc.equals(hangdonvi)){return capso;}
        return null;
    }
    ...
    private int solanxuathienChanle(String chanle,List<CapSo> list){
        ...
        for(int i=0;i<list.size();i++){
            capSo=list.get(i);
            if(capSo.getChanle().equals(chanle)){result++;}
        }                
        return result;
    }
    ...
    private HashMap<String,String> danhsachChiaHetCho3(List<CapSo> list){
       ...
       String chiahetcho3="";
       for(int i=0;i<list.size();i++ ){   
           chiahetcho3=chiaHetCho3(list.get(i).getCapso());
...
//        System.out.println(DateProc.Timestamp2DDMMYYYY(DateProc.String2Timestamp(today.getDay()+"/"+(today.getMonth()+1)+"/"+today.getYear())));
        ...
        if(dsDacBietdonvi!=null){
            CapSo capSo=null;
            for(int i=0;i<dsDacBietdonvi.size();i++){
                capSo=dsDacBietdonvi.get(i);
